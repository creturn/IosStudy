...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.mainViewContorller = [[CRNMainViewController alloc] initWithNibName:@"MainView" bundle:nil];
    UIView *mainView = self.mainViewContorller.view;
    CGRect mainViewFrame = mainView.frame;
    mainViewFrame.origin.y = [UIApplication sharedApplication].statusBarFrame.size.height;
    mainView.frame = mainViewFrame;
    self.window.rootViewController = self.mainViewContorller;
